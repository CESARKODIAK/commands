{	scopeName = 'source.applescript';
	...
	fileTypes = ( 'applescript', 'script editor', 'scpt', 'osascript' );
				...
				{	name = 'meta.block.try.applescript';
					...
					patterns = (
						{	name = 'meta.property.error.applescript';
							...
							beginCaptures = { 1 = { name = 'keyword.control.exception.on-error.applescript'; }; };
							patterns = (
		...
		blocks.statement = {
			patterns = (
				...
				{	name = 'meta.statement.error.applescript';
					...
					beginCaptures = { 1 = { name = 'keyword.control.exception.error.applescript'; }; };
					patterns = (
						{	name = 'keyword.control.exception.modifier.applescript';
