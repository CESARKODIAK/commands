...
module Exp
  ...
  module TokenData
    ...
    register_names( "COMMENT", "DIGIT", "ESC", "If", "Integer", "LETTER", 
                    ...
                    "'as'", "'aside from'", "'at'", "'be'", "'before'", 
                    "'behind'", "'below'", "'beneath'", "'beside'", "'between'", 
                    "'bigger than'", "'but not'", "'considering'", "'define'", 
                    "'done'", "'each'", "'end'", "'eq'", "'equals'", "'every'", 
                    "'finished'", "'from'", "'function'", "'funny'", "'greater than'", 
                    "'gt'", "'had'", "'has'", "'hate'", "'have'", "'how to'", 
                    "'if'", "'in'", "'ing'", "'instead of'", "'into'", "'is'", 
                    "'joyfully'", "'less than'", "'let'", "'like'", "'lt'", 
                    "'method for'", "'method'", "'never'", "'of'", "'often'", 
                    "'ok'", "'on'", "'once'", "'onto'", "'out of'", "'over'", 
                    "'qed'", "'s to'", "'s'", "'set'", "'since'", "'smaller than'", 
                    "'some'", "'stinky'", "'sucks'", "'teh'", "'that'", 
                    "'the'", "'then'", "'these'", "'this'", "'those'", "'through'", 
                    "'thru'", "'to'", "'val'", "'value of'", "'var'", "'want'", 
                    "'was'", "'where'", "'while'", "'who'", "'with'", "'without'" )
